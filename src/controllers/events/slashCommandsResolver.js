...
module.exports = function slashCommandsResolver(
  ...
  const currentDate = dayjs().tz('America/New_York').subtract(1, 'day').format('YYYY-MM-DD');
  const twoWeeksFromNow = dayjs().tz('America/New_York').add(2, 'week').format('YYYY-MM-DD');
